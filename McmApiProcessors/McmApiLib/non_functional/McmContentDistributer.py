...
__all__ = ["McmContentDistributer"]

class McmContentDistributer(McmContentDistributerBase):
    description = """Invoke a content distribution for a given
    application in MCM
    """
...
if __name__ == "__main__":
    PROCESSOR = McmContentDistributer()
